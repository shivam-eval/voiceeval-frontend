          ...
          <div className="bg-dark-panel rounded-2xl p-8 border border-gray-800/50 shadow-xl">
            ...
            <div className="pt-4 border-t border-gray-800">
              <button 
                ...
                className="w-full px-6 py-4 bg-[#b61249] hover:bg-[#c91d5a] text-white rounded-xl font-semibold text-base transition-all duration-300 shadow-lg shadow-[#b61249]/50 hover:scale-105 flex items-center justify-center gap-3"
              >
